...
Begin VB.Form frmMaitre 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8160
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13770
   Icon            =   "frmMaitre.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   8160
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from vmaitre where Codigo <> '0000' AND substring(Codigo,1,1)<>'*' order by Descripcion"
