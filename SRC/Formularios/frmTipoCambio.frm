...
Begin VB.Form frmTipoCambio 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmTipoCambio.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmTipoCambio.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmTipoCambio.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmTipoCambio.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmTipoCambio.frx":15CC
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmTipoCambio.frx":16CE
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmTipoCambio.frx":1C00
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmTipoCambio.frx":2142
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmTipoCambio.frx":2684
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmTipoCambio.frx":2BC6
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmTipoCambio.frx":3108
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmTipoCambio.frx":364A
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
    ...
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                If Not lInfhotel Then
                   ...
                   frmTipoCambioDetalle.Show vbModal
                Else
                   MsgBox "Esta opción debe realizarse desde el Infhotel", vbExclamation, sMensaje
                End If
           ...
           Case Is = 1  'Modifica
                ...
                If Not lInfhotel Then
                   If RsCabecera.RecordCount > 0 Then
                      Sw = False
                      'Cambiar el Nombre del Formulario Detalle
                      frmTipoCambioDetalle.DTFecha.Enabled = False
                      frmTipoCambioDetalle.Show vbModal
                   ...
                   End If
                Else
                   MsgBox "Esta opción debe realizarse en el Infhotel", vbExclamation, sMensaje
                End If
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Tipos de Cambio "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select fFecha, nCompra, nVenta, tUsuario, fRegistro, IsNull(nOficial,0)as nOficial, " & _
           "convert(varchar, fFecha, 103) as xFecha, str(nCompra,10,3) as xCompra, str(nVenta,10,3) as xVenta, convert(varchar, fRegistro, 103) as xRegistro, str(nOficial,10,3) as xOficial " & _
           "from TTIPOCAMBIO"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Fecha", 2, "xFecha", 2100, 2, 0, "dd/mm/yyyy", _
                                  "Compra", 2, "xCompra", 2100, 1, 0, "##0.000", _
                                  "Venta", 2, "xVenta", 2100, 1, 0, "##0.000", _
                                  "Oficial", 2, "xOficial", 2100, 1, 0, "##0.000", _
                                  "Usuario", 2, "tUsuario", 2600, 0, 0, "")
