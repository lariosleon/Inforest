...
Begin VB.Form frmPropiedad 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8160
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13740
   Icon            =   "frmPropiedad.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8160
   ScaleWidth      =   13740
   ...
   End
End
Attribute VB_Name = "frmPropiedad"
...
Dim Reporte As New dsrPropiedad
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmPropiedadDetalle.Show vbModal
...
'                CriterioF = ""
                ...
                frmFiltroPropiedad.Show vbModal
                If Not wEnter Then
                   Exit Sub
                End If
                Screen.MousePointer = vbHourglass
                If sDescrip = "Propiedades" Then
                    Isql = " SELECT dbo.TPROPIEDAD.tCodigoPropiedad AS Codigo, dbo.vOperador.Descripcion + ' ' + dbo.TPROPIEDAD.tDetallado AS Descripcion, isnull(dbo.vOperador.lStockMas,0), isnull(dbo.vOperador.lStockMenos,0), " & _
                           " dbo.TPROPIEDAD.nPrecio, isnull(dbo.vOperador.lStockMas,0), isnull(dbo.vOperador.lStockMenos,0), dbo.vProducto.Grupo, dbo.vProducto.SubGrupo, dbo.vProducto.Descripcion AS Producto, dbo.vproducto.ttipoproducto, dbo.vProducto.tGrupo, dbo.vProducto.tSubGrupo,dbo.vProducto.lactivo " & _
                           " FROM dbo.TPROPIEDAD INNER JOIN dbo.vOperador ON dbo.TPROPIEDAD.tOperador = dbo.vOperador.Codigo LEFT OUTER JOIN dbo.vProducto ON dbo.TPROPIEDAD.tProducto = dbo.vProducto.Codigo "
                Else
                    Isql = "usp_InforestAdm_ObtenerPrropiedadesReporte"
                End If
                ...
                If sDescrip = "Propiedades" Then
                    ...
                    RsReporte.Sort = grdGrilla.Columns(nColumna).DataField & ", Grupo, SubGrupo, Descripcion ASC"
                    ...
                    Reporte.Text2.SetText sRazonSocial
                    Reporte.Text14.SetText localConectado
                    Reporte.Database.SetDataSource RsReporte
                    frmEmite.CRViewer.ReportSource = Reporte
                Else
                    Dim Reporte2 As New dsrPropiedad2
        
                    Reporte2.DiscardSavedData
                    Reporte2.ReportTitle = Me.Caption
                    Reporte2.SelectPrinter Printer.DriverName, Printer.DeviceName, Printer.Port
                    Reporte2.PaperOrientation = crPortrait
                    Reporte2.Text2.SetText sRazonSocial
                    Reporte2.Text12.SetText localConectado
                       ...
                       Case "Excel"
                            ...
                            Else
                                ...
                                If cmdSave1.FileName = "" Then
                                   Exit Sub
                                End If
                                Reporte2.ExportOptions.DiskFileName = cmdSave1.FileName
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "SELECT DISTINCT Codigo, Descripcion, Operador, tResumido, lActivo, tOperador, lValor, lStockMas, lStockMenos, nControl, nPrecio, tEnlace, tArea, lsolicitaCantidad from vPropiedad order by Codigo"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
   'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo", 2, "Codigo", 800, 2, 0, "", _
                                  "Operador", 2, "Operador", 2000, 0, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 4000, 0, 0, "", _
                                  "Descripción Resumida", 2, "tResumido", 3000, 0, 0, "", _
                                  "Solicita Cantidad", 2, "lSolicitaCantidad", 2400, 2, 4, "", _
                                  "Activo", 2, "lactivo", 1200, 2, 4, "")
