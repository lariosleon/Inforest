...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmDistritoDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select Codigo,Descripcion,tResumido,lActivo,tvalor from vDistrito where Codigo <> '00'"
