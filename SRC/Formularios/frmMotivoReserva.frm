...
Begin VB.Form frmMotivoReserva 
   ClientHeight    =   8085
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   13710
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmMotivoReserva.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmMotivoReserva.frx":0542
            Style           =   1  'Graphical
            TabIndex        =   18
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmMotivoReserva.frx":0A84
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmMotivoReserva.frx":0FC6
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmMotivoReserva.frx":1508
            Style           =   1  'Graphical
            TabIndex        =   15
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmMotivoReserva.frx":1A4A
            Style           =   1  'Graphical
            TabIndex        =   14
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmMotivoReserva.frx":1F8C
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmMotivoReserva.frx":24BE
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmMotivoReserva.frx":25C0
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmMotivoReserva.frx":2AF2
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmMotivoReserva.frx":2BE4
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmMotivoReserva.frx":2CE6
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmMotivoReserva.frx":3218
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmMotivoReserva"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmMotivoReservaDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from vMotivoReserva"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(4, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                    "Descripción Detallada", 2, "Detallado", 4000, 0, 0, "", _
                                    "Descripción Resumida", 2, "Resumido", 2700, 0, 0, "", _
                                    "Activo", 2, "Activo", 1500, 2, 4, "")
