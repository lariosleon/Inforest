...
Begin VB.Form frmMotivoDescuento 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8175
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13770
   Icon            =   "frmMotivoDescuento.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8175
   ScaleWidth      =   13770
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmMotivoDescuento.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmMotivoDescuento.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmMotivoDescuento.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmMotivoDescuento.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmMotivoDescuento.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmMotivoDescuento.frx":15CC
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmMotivoDescuento.frx":16CE
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmMotivoDescuento.frx":1C00
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmMotivoDescuento.frx":2142
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmMotivoDescuento.frx":2684
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmMotivoDescuento.frx":2BC6
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmMotivoDescuento.frx":3108
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmMotivoDescuento.frx":364A
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMotivoDescuento"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmMotivoDescuentoDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Motivo de Descuentos "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select Codigo, Descripcion, tResumido, nRatio,  lActivo, nTope, lRatio, lTopePedido, lBloqueo, lAplicablePedido, " & _
           "str(case lRatio when 1 then nRatio else 0 end,10,2) Ratio, " & _
           "str(case lRatio when 1 then 0 else nRatio end,10,2) Monto, " & _
           "str(case lTopePedido when 1 then nTope else 0 end,10,2) TopePedido, " & _
           "str(case lTopePedido when 1 then 0 else nTope end,10,2) TopeMes, AplicaAnticipo " & _
           "from vMotivoDescuento where Codigo<>'000'"
           
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(9, grdGrilla, "Codigo", 2, "Codigo", 1000, 2, 0, "", _
                                  "Descripción", 2, "Descripcion", 2600, 0, 0, "", _
                                  "Ratio Dscto", 2, "Ratio", 1100, 1, 0, "##0.00", _
                                  "Monto Dscto", 2, "Monto", 1100, 1, 0, "##0.00", _
                                  "Tope Pedido", 2, "TopePedido", 1100, 1, 0, "##0.00", _
                                  "Tope Mes", 2, "TopeMes", 1100, 1, 0, "##0.00", _
                                  "Cambiar", 2, "lBloqueo", 1000, 2, 4, "", _
                                  "Aplicab", 2, "lAplicablePedido", 1000, 2, 4, "", _
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmMotivoDescuento = Nothing
End Sub
