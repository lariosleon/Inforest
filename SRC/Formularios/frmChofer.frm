...
Begin VB.Form frmChofer 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   7365
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   11850
   Icon            =   "frmChofer.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7365
   ScaleWidth      =   11850
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Chofers "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vChofer where Codigo <> '00' order by Descripcion"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(4, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Nombres y Apellidos", 2, "Descripcion", 5500, 0, 0, "", _
                                  "Numero Brevete", 2, "tResumido", 3220, 0, 0, "", _
