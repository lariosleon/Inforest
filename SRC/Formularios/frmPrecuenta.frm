...
Begin VB.Form frmPrecuenta 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   7365
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   11850
   Icon            =   "frmPrecuenta.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7365
   ScaleWidth      =   11850
   ...
   End
End
Attribute VB_Name = "frmPrecuenta"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmPrecuentaDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Configuración de Precuentas "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vPrecuentaImpresora"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(4, grdGrilla, "Caja", 2, "Caja", 2000, 0, 0, "", _
                                  "Impresora", 2, "Impresora", 3000, 0, 0, "", _
                                  "Salon", 2, "Salon", 3000, 0, 0, "", _
                                  "Mesa", 2, "Mesa", 3000, 0, 0, "")
