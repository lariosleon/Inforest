...
Begin VB.Form frmMozo 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8175
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13785
   Icon            =   "frmMozo.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   8175
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from vMozo where Codigo <> '0000' AND substring(Codigo,1,1)<>'*' order by Descripcion"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 4500, 0, 0, "", _
                                  "Descripción Resumida", 2, "tResumido", 2800, 0, 0, "", _
                                  "Ver Ctas", 2, "nValor", 1100, 2, 4, "", _
