...
Begin VB.Form frmReciboIngreso 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8655
   ClientLeft      =   -3525
   ClientTop       =   -1125
   ClientWidth     =   13725
   Icon            =   "frmReciboIngreso.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8625.856
   ScaleMode       =   0  'User
   ScaleWidth      =   13725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmReciboIngreso.frx":030A
            Style           =   1  'Graphical
            TabIndex        =   1
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmReciboIngreso.frx":084C
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmReciboIngreso.frx":0D8E
            Style           =   1  'Graphical
            TabIndex        =   0
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmReciboIngreso.frx":12D0
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmReciboIngreso.frx":1812
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmReciboIngreso.frx":1D54
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmReciboIngreso.frx":2296
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmReciboIngreso.frx":27C8
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmReciboIngreso.frx":28CA
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmReciboIngreso.frx":2DFC
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdProcesa 
         Height          =   555
         Left            =   5880
         Picture         =   "frmReciboIngreso.frx":2EEE
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Filtrar"
         Top             =   810
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmReciboIngreso.frx":2FF0
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmReciboIngreso.frx":3522
         Style           =   1  'Graphical
         TabIndex        =   9
   ...
   End
End
Attribute VB_Name = "frmReciboIngreso"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           ...
           Case Is = 5  'Emite
                ...
                Reporte.Text8.SetText "Reporte de Recibos de Ingreso"
...
Private Sub cmdProcesa_Click()
   Screen.MousePointer = vbHourglass
    ...
    If lMCPV Then
       Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, estadodocumento as Estado, Moneda, treferencia, ttipopago,ttarjeta,lanticipo, str(nMonto,10,2) as xMonto, convert(varchar, fFecha, 103) as xFecha, Pedido from vingreso " & _
...
Private Sub Form_Load()
    ...
    Call ConfGrilla(9, grdGrilla, "Recibo", 2, "tRecibo", 1200, 0, 0, "", _
                                  "Fecha", 2, "xFecha", 1200, 0, 0, "", _
                                  "Mon", 2, "Moneda", 550, 2, 0, "", _
                                  "Monto", 2, "xMonto", 1200, 1, 0, "", _
                                  "Anticipo", 2, "lAnticipo", 900, 2, 4, "", _
                                  "Descripción", 2, "tDescripcion", 3500, 0, 0, "", _
                                  "Autoriza", 2, "tAutoriza", 1600, 0, 0, "", _
                                  "Estado", 2, "Estado", 1300, 0, 0, "", _
                                  "Turno", 2, "tTurno", 1200, 0, 0, "", _
                                  "Ped. Refer.", 2, "pedido", 1200, 0, 0, "")
