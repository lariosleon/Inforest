...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmImpresoraDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    'Ingrese la Vista
    Isql = "select tImpresora, tDescripcion, tDevice, tRuta, tFont, tFont1, tFont2, tNumeroSerie, nFontSizePrecuenta, nFontSizeEnvio, isnull(lvineta,0) lvineta,isnull(nWidthVineta,0) nWidthVineta,isnull(nHeightVineta,0) nHeightVineta  from TIMPRESORA where tCaja ='" & sCaja & "'"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "tImpresora", 800, 2, 0, "", _
                                  "Descripción", 2, "tDescripcion", 2400, 0, 0, "", _
                                  "Nombre", 2, "tDevice", 3800, 0, 0, "", _
                                  "Font", 2, "tFont", 2400, 0, 0, "", _
                                  "Nro. Serie", 2, "tNumeroSerie", 1600, 0, 0, "")
