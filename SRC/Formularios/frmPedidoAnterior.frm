...
Begin VB.Form frmPedidoAnterior 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4380
   ClientLeft      =   -660
   ClientTop       =   1815
   ClientWidth     =   11220
   Icon            =   "frmPedidoAnterior.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4380
   ...
   Begin VB.PictureBox Picture 
      ...
      Begin VB.CommandButton cmdSalir 
         ...
         Index           =   6
         Left            =   8640
         Picture         =   "frmPedidoAnterior.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   30
         Width           =   1170
      ...
      Begin VB.PictureBox PicNavegacion 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmPedidoAnterior.frx":0534
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmPedidoAnterior.frx":0A76
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmPedidoAnterior.frx":0FB8
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   7785
            Picture         =   "frmPedidoAnterior.frx":14FA
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   7245
            Picture         =   "frmPedidoAnterior.frx":1A3C
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   6705
            Picture         =   "frmPedidoAnterior.frx":1F7E
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
   ...
   Begin VB.Image Image 
      Height          =   3600
      Left            =   30
      Picture         =   "frmPedidoAnterior.frx":24C0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1185
   End
End
Attribute VB_Name = "frmPedidoAnterior"
...
Private Sub Form_Load()
    ...
    Centrar Me
    'Ingrese el Titulo
    Me.Caption = " Visualización de Pedidos ReFacturados "
    
    'Ingrese el SubTitulo
    grdGrilla.Caption = " Pedidos Refacturados "
