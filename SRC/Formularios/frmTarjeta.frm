...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmTarjetaDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Tarjetas "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    ' se agrego el campo de tCodTarjetaEx al query
    Isql = "select tCodigoTarjeta, tDetallado, nFactorRetencion, lActivo, tResumido, tTelefono1, tTelefono2, tRepresentante, nBoton, tCuentaContable, lPinPad, str(nFactorRetencion,10,2) as xFactorRetencion, tCodTarjetaEx from TTARJETACREDITO"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "tCodigoTarjeta", 1000, 2, 0, "", _
                                  "Descripción", 2, "tDetallado", 5300, 0, 0, "", _
                                  "Factor", 2, "xFactorRetencion", 1200, 1, 0, "##0.00", _
                                  "Cta.Ctable", 2, "tCuentaContable", 2200, 0, 0, "", _
                                  "Activo", 2, "lactivo", 1300, 2, 4, "")
