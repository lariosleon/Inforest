...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Grupos y SubGrupos "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select tCodigoGrupo AS Codigo, tDetallado AS Descripcion, tResumido, nBoton, lActivo, tCaja  from TGRUPO"
