...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "SELECT TRESERVA.tReserva, TRESERVA.fFecha, TRESERVA.fHora, TRESERVA.tApellido,TRESERVA.tCodigoDelivery, TDELIVERY.tApellido+' '+TDELIVERY.tNombre AS Cliente, TRESERVA.tNombre,TRESERVA.tMesero, TRESERVA.tMotivo, TRESERVA.tTelefono, TRESERVA.nPax, TRESERVA.tEstadoReserva, TRESERVA.tObservacion, TRESERVA.fRegistro, TRESERVA.tMesa, vEstadoReserva.Descripcion AS EstadoReserva, " & _
           "convert(varchar, fFecha, 103) as xFecha, convert(varchar, fHora, 103) as xHora, str(nPax,10,2) as xPAx " & _
           "FROM TRESERVA LEFT JOIN vEstadoReserva ON TRESERVA.tEstadoReserva = vEstadoReserva.Codigo LEFT JOIN TDELIVERY ON TRESERVA.tCodigoDelivery = TDELIVERY.tCodigoDelivery " & _
           "where tPrioridad = '1' and fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' " & _
           "order by tReserva"
    
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    'Configuración de la Grilla
    Call ConfGrilla(8, grdGrilla, "Reserva", 2, "tReserva", 1200, 2, 0, "", _
                                  ...
                                  "Observación", 2, "tObservacion", 3400, 0, 0, "")
