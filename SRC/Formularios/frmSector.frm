...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Sectores "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vSector"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(4, grdGrilla, "Codigo", 2, "Codigo", 1500, 2, 0, "", _
                                    "Detallado", 2, "Descripcion", 4500, 0, 0, "", _
                                    "Resumido", 2, "tresumido", 3500, 0, 0, "", _
