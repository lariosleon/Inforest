...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmPropertyDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from vProperty order by Operador, Descripcion"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1100, 2, 0, "", _
                                  "Operador", 2, "Operador", 2800, 0, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 4050, 0, 0, "", _
                                  "Descripción Resumida", 2, "tResumido", 2000, 0, 0, "", _
