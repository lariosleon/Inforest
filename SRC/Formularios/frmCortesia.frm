...
Begin VB.Form frmCortesia 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8160
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13770
   Icon            =   "frmCortesia.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8160
   ScaleWidth      =   13770
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmCortesiaDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Cortesias "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vCortesia where Codigo <> '00' order by Descripcion"
