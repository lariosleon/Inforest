...
Begin VB.Form frmInventarioConsolidado 
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   3
      Left            =   7590
      Picture         =   "frmInventarioConsolidado.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5250
      Width           =   1455
   ...
   Begin VB.CommandButton CmdActualiza 
      ...
      Height          =   615
      Left            =   6150
      Picture         =   "frmInventarioConsolidado.frx":00F2
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   5250
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   2
      Left            =   4710
      Picture         =   "frmInventarioConsolidado.frx":01BA
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   5250
      Width           =   1455
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   1
      Left            =   3270
      Picture         =   "frmInventarioConsolidado.frx":09DC
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   5250
      Width           =   1455
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   0
      Left            =   1830
      Picture         =   "frmInventarioConsolidado.frx":0F0E
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   5250
      Width           =   1455
   ...
   End
End
Attribute VB_Name = "frmInventarioConsolidado"
...
Dim CrtReporteT1  As New dsrInventarioConsolidado
...
Sub CreaTemporal()
        ...
        sNombre = dbTemporal(sUsuario, 7, "tLocalidad", "nVarChar(250)", _
                                           "tNombreColumna", "nVarChar(350)", _
                                           "tcodigoproducto", "nVarChar(7)", _
                                           "tdetallado", "nVarChar(250)", _
                                           "DESCRIPCION", "nVarChar(100)", _
                                           "Cantidad", "float", _
                                           "tipo", "nVarChar(1)")
                                           
'tcodigoproducto , tdetallado, DESCRIPCION, Cantidad, Tipo
    ...
    For w = 1 To lstServidores.ListItems.Count
        If lstServidores.ListItems.Item(w).Checked = True Then
            ...
            End If
                ...
                If Not oComando.CreateCmdSp("SP_InventarioConsolidado", devuelveConexion(lstServidores.ListItems.Item(w).SubItems(4), lstServidores.ListItems.Item(w).SubItems(5))) Then
                    Set oComando = Nothing
                    Exit Sub
                End If
            
            oComando.CreateParameter "@fch_fregistro", adVarChar, adParamInput, 20, Format(dtpFecIni.value, "yyyy/MM/dd") & " " & Format(dtpHorIni.value, "HH:mm:ss")
            oComando.CreateParameter "@vch_areas", adVarChar, adParamInput, 3, IIf(dtcArea.BoundText = "", "", dtcArea.BoundText)
            oComando.CreateParameter "@vch_Condicion", adVarChar, adParamInput, 3000, tCondicion
            
'            oComando.CreateParameter "tLocalidad", adVarChar, adParamInput, 100, lstServidores.ListItems.Item(w).SubItems(5)
'            oComando.CreateParameter "tNombreColumna", adVarChar, adParamInput, 350, lstServidores.ListItems.Item(w).SubItems(5)
'            oComando.CreateParameter "tcodigoproducto", adVarChar, adParamInput, 7, lstServidores.ListItems.Item(w).SubItems(5)
'            oComando.CreateParameter "tdetallado", adVarChar, adParamInput, 250, lstServidores.ListItems.Item(w).SubItems(5)
'            oComando.CreateParameter "DESCRIPCION", adVarChar, adParamInput, 100, lstServidores.ListItems.Item(w).SubItems(5)
'            oComando.CreateParameter "Cantidad", adVarChar, adParamInput, 1, lstServidores.ListItems.Item(w).SubItems(5)
...
'"tLocalidad, tNombreColumna, tcodigoproducto, tdetallado, DESCRIPCION, Cantidad
                    
                        Isql = "INSERT INTO " & sNombre & "(tLocalidad, tNombreColumna, tcodigoproducto, tdetallado, DESCRIPCION, Cantidad,Tipo) " & _
                               " VALUES('" & llocal & "','" & llocal & " - " & IIf(!Tipo = "C", "Cantidad", "Monto") & "','" & !tcodigoproducto & "','" & !tDetallado & "', '" & !Descripcion & "'," & !Cantidad & ",'" & !Tipo & "')"
'                    Debug.Print Isql
                    Cn.Execute Isql
                    RsDatos.MoveNext
                Wend
...
sigue:
    Next w
        ...
        Isql = "INSERT INTO " & sNombre & "(tLocalidad, tNombreColumna, tcodigoproducto, tdetallado, DESCRIPCION, Cantidad,Tipo) " & _
               "select 'Total','Total ' + (case when Tipo = 'C' then 'Cantidad' else 'Monto' end), tcodigoproducto,tdetallado,descripcion,sum(cantidad),'T' from " & sNombre & " group by  left(tnombrecolumna,1),  tcodigoproducto,tdetallado,descripcion,Tipo order by tdetallado"
'        Debug.Print Isql
        Cn.Execute Isql
    
        Isql = " Select tLocalidad, tNombreColumna, tcodigoproducto, tdetallado, DESCRIPCION, Cantidad from " & sNombre & " order by tLocalidad,tcodigoproducto"
    ...
    If Index <> 3 Then
        ...
        If ChkFamilia.value = 0 Then
            If CboFamilia.BoundText = "" Then
                ...
                Exit Sub
            End If
            tCondicion = tCondicion & " dbo.TPRODUCTO.tCodigoFamilia ='" & CboFamilia.BoundText & "'"
        End If
      '(dbo.TPRODUCTO.tCodigoFamilia = N'123') AND (dbo.TPRODUCTO.tCodigoSubFamilia = N'123')
        If ChkSubFamilia.value = 0 Then
            If CboSubFamilia.BoundText = "" Then
                ...
                Exit Sub
            End If
            tCondicion = tCondicion & " and dbo.TPRODUCTO.tCodigoSubFamilia='" & CboSubFamilia.BoundText & "'"
        End If
        ...
        If ChkArticulo.value = 0 Then
            If TxtCodigo.Text = "" Then
                ...
                Exit Sub
            End If
            tCondicion = tCondicion & " and dbo.TPRODUCTO.tcodigoproducto='" & Me.TxtCodigo.Text & "'"
        End If
        If Left(tCondicion, 4) = " and" Then
            tCondicion = Right(tCondicion, Len(tCondicion) - 4)
        End If
        
        sTitulo = "Al " & Format(dtpFecIni.value, "dd/mmm/yyyy") & " " & Format(dtpHorIni.value, "hh:mm") '& " al " & Format(dtpFecFin.value, "dd/mmm/yyyy") & " " & Format(dtpHorFin.value, "hh:mm")
...
'                        If optOpcion(0).value Then  'Por Tipo de Documento
                            ...
                            CrtReporteT1.PaperOrientation = 2
...
Private Sub Form_Load()
    ...
    dtpFecIni.value = Date ' "01/" & str(Month(Date)) & "/" & str(Year(Date))
