...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmClienteDetalle.Show vbModal
           ...
           Case Is = 5  'Emite
                frmRepClienteCtaCte.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Clientes Cuentas Corrientes "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vCompania"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(8, grdGrilla, "Cod", 2, "Codigo", 800, 2, 0, "", _
                                  "Razón Social / Nombre", 2, "Descripcion", 3000, 0, 0, "", _
                                  "Identidad", 2, "Identidad", 1500, 0, 0, "", _
                                  "Dirección", 2, "tDireccion", 2800, 0, 0, "", _
                                  "Teléfono", 2, "tTelefono1", 1000, 0, 0, "", _
                                  "Linea", 2, "nLinea", 1000, 1, 0, "###,##0.00", _
                                  "Consumo", 2, "nConsumo", 1000, 1, 0, "###,##0.00", _
