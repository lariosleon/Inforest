...
Dim Reporte As New dsrReporte6
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           ...
           Case Is = 5  'Emite
                ...
                Reporte.Text8.SetText localConectado
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Establecimientos (Locales) "
    ...
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 2200, 2, 0, "", _
                                    "Detallado", 2, "Descripcion", 3800, 0, 0, "", _
                                    "Resumido", 2, "tresumido", 3800, 0, 0, "", _
                                    "Enlace Contable", 2, "tEnlaceContable", 3800, 0, 0, "", _
