...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select *, str(nValor,10,2) as xValor from vZona where Codigo <> '00' order by Descripcion"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Descripción", 2, "Descripcion", 4000, 0, 0, "", _
                                  "Referencia", 2, "tResumido", 3000, 0, 0, "", _
                                  "Tiempo", 2, "xValor", 1200, 1, 0, "", _
