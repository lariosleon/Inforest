...
Begin VB.Form frmClienteFactura 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8175
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13755
   Icon            =   "frmClienteFactura.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8175
   ScaleWidth      =   13755
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmClienteFactura.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmClienteFactura.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmClienteFactura.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmClienteFactura.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmClienteFactura.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmClienteFactura.frx":15CC
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmClienteFactura.frx":16CE
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmClienteFactura.frx":1C00
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmClienteFactura.frx":2142
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmClienteFactura.frx":2684
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmClienteFactura.frx":2BC6
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmClienteFactura.frx":3108
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmClienteFactura.frx":364A
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
   ...
   End
End
Attribute VB_Name = "frmClienteFactura"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmClienteFacturaDetalle.lagregar = True
                frmClienteFacturaDetalle.Show vbModal
                      
           Case Is = 1  'Modifica
                If RsCabecera.RecordCount > 0 Then
                    Sw = False
                    'Cambiar el Nombre del Formulario Detalle
                    frmClienteFacturaDetalle.lagregar = False
                    frmClienteFacturaDetalle.Show vbModal
                Else
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Clientes Facturados "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 0
    
    ' Ingrese la Vista
    Isql = "select * from vCliente order by Codigo"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo", 2, "Codigo", 1100, 2, 0, "", _
                                  "Razón Social", 2, "Descripcion", 3900, 0, 0, "", _
                                  "Tipo Identidad", 2, "TipoIdentidad", 2000, 0, 0, "", _
                                  "Id. Tributario", 2, "tIdentidad", 1600, 0, 0, "", _
                                  "Dirección", 2, "tDireccion", 4300, 0, 0, "", _
