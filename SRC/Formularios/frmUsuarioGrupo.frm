...
Begin VB.Form frmUsuarioGrupo 
   ...
   Begin VB.PictureBox Picture 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   6990
         Picture         =   "frmUsuarioGrupo.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   8190
         Picture         =   "frmUsuarioGrupo.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   9390
         Picture         =   "frmUsuarioGrupo.frx":0A76
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   10590
         Picture         =   "frmUsuarioGrupo.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   7
         Left            =   6990
         Picture         =   "frmUsuarioGrupo.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   720
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   2
         Left            =   8190
         Picture         =   "frmUsuarioGrupo.frx":119C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   720
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   3
         Left            =   9390
         Picture         =   "frmUsuarioGrupo.frx":129E
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   720
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   4
         Left            =   10590
         Picture         =   "frmUsuarioGrupo.frx":13A0
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   720
         Width           =   1170
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmUsuarioGrupo.frx":14A2
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmUsuarioGrupo.frx":19E4
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmUsuarioGrupo.frx":1F26
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   6195
            Picture         =   "frmUsuarioGrupo.frx":2468
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   5655
            Picture         =   "frmUsuarioGrupo.frx":29AA
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   5115
            Picture         =   "frmUsuarioGrupo.frx":2EEC
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmUsuarioGrupoDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from TGRUPOUSUARIO"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo", 2, "tGrupoUsuario", 1200, 2, 0, "", _
                                   "Descripción", 2, "tDetallado", 3800, 0, 0, "", _
                                   "Punto de Venta", 2, "lModulo01", 1550, 2, 4, "", _
                                   "Administración", 2, "lModulo02", 1550, 2, 4, "", _
                                   "Consultas", 2, "lModulo03", 1550, 2, 4, "", _
                                   "Activo", 2, "lactivo", 1400, 2, 4, "")
