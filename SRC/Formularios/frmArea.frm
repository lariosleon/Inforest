...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Areas de Producción "
    ...
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1100, 2, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 4100, 0, 0, "", _
                                  "Descripción Resumida", 2, "tResumido", 3200, 0, 0, "", _
                                  "Chef Control", 2, "lCheffControl", 1100, 2, 4, "", _
