...
Begin VB.Form frmTipoDocumento 
   ...
   ClientTop       =   1725
   ClientWidth     =   13755
   Icon            =   "frmTipoDocumento.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8160
   ScaleWidth      =   13755
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmTipoDocumento.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmTipoDocumento.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmTipoDocumento.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmTipoDocumento.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmTipoDocumento.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmTipoDocumento.frx":15CC
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmTipoDocumento.frx":16CE
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmTipoDocumento.frx":1C00
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmTipoDocumento.frx":2142
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmTipoDocumento.frx":2684
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmTipoDocumento.frx":2BC6
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmTipoDocumento.frx":3108
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmTipoDocumento.frx":364A
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmTipoDocumentoDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Tipo de Documentos "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    'Isql = "select Codigo, Descripcion, Prefijo, Cliente, Sunat, Monto, RegistroVenta, Transporte, lActivo, Canjear, lValidaRuc,lImprimeQR, tCodigoExterno, lFacturacionE, lNotaCredito, lValidaEmail,tImpresionFE, limpresionretencion,lidentidadruc,lidentidadotros, nMontoMaximo, nMontoMinimo, lImpObs, CodigoPlantilla from vTipoDocumento where Codigo <> '00'"
    Isql = "select * from vTipoDocumento where Codigo <> '00'"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    If pais = "001" Then
       
    'Configuración de la Grilla
    Call ConfGrilla(7, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Descripción", 2, "Descripcion", 5030, 0, 0, "", _
                                  "Prefijo", 2, "Prefijo", 1200, 2, 0, "", _
                                  "Cliente", 2, "Cliente", 1200, 2, 4, "", _
                                  "Cod.Doc", 2, "Sunat", 1200, 0, 0, "", _
                                  "Imprime QR", 2, "lImprimeQR", 1400, 2, 4, "", _
                                  "Activo", 2, "lActivo", 1200, 2, 4, "")
                                  
    Else
    
    'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Descripción", 2, "Descripcion", 5030, 0, 0, "", _
                                  "Prefijo", 2, "Prefijo", 1200, 2, 0, "", _
                                  "Cliente", 2, "Cliente", 1200, 2, 4, "", _
                                  "Cod.Doc", 2, "Sunat", 1200, 0, 0, "", _
