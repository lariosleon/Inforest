...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmUsuarioDetalle.Grilla (1)
                frmUsuarioDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    Isql = "SELECT TUSUARIO.tCodigoUsuario AS Codigo, TUSUARIO.tDetallado AS Descripcion, TUSUARIO.tResumido, TUSUARIO.lActivo, TUSUARIO.tPassword, TUSUARIO.tGrupoUsuario, TUSUARIO.tBandaMagnetica, dbo.tGrupoUsuario.tDetallado as Grupo, TUSUARIO.tHuella, TUSUARIO.fRegistro, TUSUARIO.tUsuarioModifica  " & _
           "FROM dbo.TUSUARIO INNER JOIN dbo.TGRUPOUSUARIO ON dbo.TUSUARIO.tGrupoUsuario = dbo.tGrupoUsuario.tGrupoUsuario " & _
           "WHERE substring(TUSUARIO.tCodigoUsuario,1,1)<>'*'"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(7, grdGrilla, "Codigo", 2, "Codigo", 1100, 2, 0, "", _
                                  "Usuario", 2, "tResumido", 2000, 0, 0, "", _
                                  "Descripción ", 2, "Descripcion", 3800, 0, 0, "", _
                                  "Grupo ", 2, "Grupo", 3000, 0, 0, "", _
                                  "Fecha", 2, "fRegistro", 1400, 0, 0, "dd/MM/yyyy", _
                                  "UsuarioModifica", 2, "tUsuarioModifica", 2000, 0, 0, "", _
