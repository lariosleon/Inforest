...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmVehiculoDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Vehiculos "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    ' Ingrese la Vista
    Isql = "select * from vVehiculo where Codigo <> '00' order by Descripcion"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Vehículo - Placa", 2, "Descripcion", 2900, 0, 0, "", _
                                  "Marca", 2, "Marca", 2900, 0, 0, "", _
                                  "Número de Serie", 2, "Serie", 2900, 0, 0, "", _
