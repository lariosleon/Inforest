...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmOperadorDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    Call ConfGrilla(7, grdGrilla, "Codigo", 2, "Codigo", 1200, 2, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 3100, 0, 0, "", _
                                  "Descrip. Resumida", 2, "tResumido", 1850, 0, 0, "", _
                                  "Precio (+)", 2, "lValor", 1200, 2, 4, "", _
                                  "Stock (+)", 2, "lStockMas", 1200, 2, 4, "", _
                                  "Stock (-)", 2, "lStockMenos", 1200, 2, 4, "", _
