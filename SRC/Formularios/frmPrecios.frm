...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select Codigo, Grupo, SubGrupo, Descripcion, nPrecioVenta, nPrecioDelivery, nPrecioLlevar, lActivo from vProducto"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(8, grdGrilla, "Codigo", 2, "Codigo", 800, 2, 0, "", _
                                  "Grupo", 2, "Grupo", 1400, 0, 0, "", _
                                  "SubGrupo", 2, "SubGrupo", 1700, 0, 0, "", _
                                  "Producto", 2, "Descripcion", 3200, 0, 0, "", _
                                  "Salon", 2, "nPrecioVenta", 1000, 1, 0, "###,###,##0.00", _
                                  "Delivery", 2, "nPrecioDelivery", 1000, 1, 0, "###,###,##0.00", _
                                  "Llevar", 2, "nPrecioLlevar", 1000, 1, 0, "###,###,##0.00", _
