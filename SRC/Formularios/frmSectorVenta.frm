...
Begin VB.Form frmSectorVenta 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8160
   ClientLeft      =   2535
   ClientTop       =   1725
   ClientWidth     =   13755
   Icon            =   "frmSectorVenta.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8160
   ScaleWidth      =   13755
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmSectorVenta.frx":0442
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmSectorVenta.frx":0984
            Style           =   1  'Graphical
            TabIndex        =   18
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmSectorVenta.frx":0EC6
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmSectorVenta.frx":1408
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmSectorVenta.frx":194A
            Style           =   1  'Graphical
            TabIndex        =   15
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmSectorVenta.frx":1E8C
            Style           =   1  'Graphical
            TabIndex        =   14
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmSectorVenta.frx":23CE
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmSectorVenta.frx":2900
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmSectorVenta.frx":2A02
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmSectorVenta.frx":2F34
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmSectorVenta.frx":3026
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmSectorVenta.frx":3128
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmSectorVenta.frx":365A
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmSectorVenta"
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                Sw = True
                frmSectorVentaDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    Me.Caption = " Mantenimiento de Agrupacion de Puntos de Ventas "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    Isql = "select * from vSectorVenta"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    Call ConfGrilla(5, grdGrilla, "Codigo", 2, "Codigo", 1000, 2, 0, "", _
                                    "Detallado", 2, "Detallado", 3200, 0, 0, "", _
                                    "Resumido", 2, "Resumido", 2800, 0, 0, "", _
                                    "CuentaContable", 2, "CuentaContable", 2800, 0, 0, "", _
                                    "Activo", 2, "Activo", 1000, 2, 4, "")
