...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Guias "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    
    Isql = "select * from vGuia order by tguia"
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    Call ConfGrilla(7, grdGrilla, "Guia", 2, "tGuia", 1500, 2, 0, "", _
                                  "Fecha", 2, "fFecha", 930, 2, 0, "", _
                                  "Destinatario", 2, "Destinatario", 2120, 0, 0, "", _
                                  "Transportista", 2, "Transportista", 2120, 0, 0, "", _
                                  "Motivo", 2, "Motivo", 1600, 0, 0, "", _
                                  "Documento", 2, "tDocumento", 1920, 0, 0, "", _
                                  "Estado", 2, "Estado", 1100, 0, 0, "")
