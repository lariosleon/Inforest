...
Begin VB.Form frmGuiaTransporte 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8175
   ClientLeft      =   -3525
   ClientTop       =   -1125
   ClientWidth     =   13770
   Icon            =   "frmGuiaTransporte.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8147.475
   ScaleMode       =   0  'User
   ScaleWidth      =   13770
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5880
         Picture         =   "frmGuiaTransporte.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Detalle de Guia"
         Top             =   90
         Width           =   555
      End
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmGuiaTransporte.frx":044C
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   9
         Left            =   8235
         Picture         =   "frmGuiaTransporte.frx":097E
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Reimpresion de Giuas"
         Top             =   90
         Width           =   555
      End
      ...
      Begin VB.CommandButton cmdProcesa 
         Height          =   555
         Left            =   13095
         Picture         =   "frmGuiaTransporte.frx":0EB0
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmGuiaTransporte.frx":0FB2
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   2
         Left            =   7065
         Picture         =   "frmGuiaTransporte.frx":10A4
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmGuiaTransporte.frx":15D6
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmGuiaTransporte.frx":16D8
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmGuiaTransporte.frx":1C1A
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmGuiaTransporte.frx":215C
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmGuiaTransporte.frx":269E
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmGuiaTransporte.frx":2BE0
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmGuiaTransporte.frx":3122
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGuiaTransporte"
...
Dim dsrReporte As New dsrGuiaCorrelativo
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           ...
           Case Is = 2
                If MsgBox("¿Que Desea Realizar? " & vbNewLine & vbNewLine & "SI: Emite Reporte" & vbNewLine & vbNewLine & "NO: Exporta Excel", vbYesNo, "Exportar/Emite") = vbYes Then
                     EmiteReporte (1)
                Else
                     EmiteReporte (2)
                End If
           ...
           Case Is = 9  'Reimpresion de Guias
               ...
               sDocumento = RsCabecera!tGuiaTransporte
               'Set RsEmision = Lib.OpenRecordset("SELECT * from vGuiaTransporte where tGuiaTransporte ='" & sDocumento & "' and tCaja='" & sCaja & "'", Cn)
                If lAlmacen And sEmpresa = "100" Then
                    Set RsEmision = Lib.OpenRecordset("select vg.*, isnull(at.UnidadEntrada,'Sin UM') as UM from vGuiaTransporte vg left join " & sAlmacenMDB & ".dbo.vPRODUCTO at on vg.tenlace= at.tCodigoProducto where  vg.tGuiaTransporte ='" & sDocumento & "' and vg.tCaja='" & sCaja & "'", Cn)
                ...
                Else
                    Set RsEmision = Lib.OpenRecordset("SELECT *,'Sin UM' as UM from vGuiaTransporte where tGuiaTransporte ='" & sDocumento & "' and tCaja='" & sCaja & "'", Cn)
               ...
               sImp = Calcular("select tImpresora as Codigo from vTipoDocumentoImpresora where tCaja='" & sCaja & "' and Transporte=1 and Prefijo= '" & Mid(sDocumento, 1, 1) & "'", Cn)
               Printer.FontName = sFont
               Printer.FontBold = False
               ImprimeGuiaTransporte RsEmision, sEmpresa
               LimpiaRs
...
Private Sub Form_Load()
    Screen.MousePointer = vbHourglass
    ' Ingrese el Titulo
    Me.Caption = " Correlativo de Guias de Transporte "
    ...
    ' Ingrese la Vista
    Isql = "select distinct tGuiaTransporte, fFecha, nTotal, Destinatario, Tienda, Estado, tTurno, Documento From vGuiaTransporte " & _
           "where fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' and tCaja='" & sCaja & "' "

    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(8, grdGrilla, "Guia", 2, "tGuiaTransporte", 1800, 0, 0, "", _
                                  "Fecha", 2, "fFecha", 1200, 0, 0, "dd/mm/yyyy", _
                                  "Monto", 2, "nTotal", 1200, 1, 0, "###,###,##0.00", _
                                  "Destinatario", 2, "Destinatario", 4600, 0, 0, "", _
                                  "Tienda", 2, "Tienda", 2200, 0, 0, "", _
                                  "Estado", 2, "Estado", 1300, 0, 0, "", _
                                  "Documento", 2, "Documento", 1800, 0, 0, "", _
                                  "Turno", 2, "tTurno", 1200, 0, 0, "")
...
Private Sub cmdProcesa_Click()
   ...
   If lMCPV Then
       Isql = "select distinct tGuiaTransporte, fFecha, nTotal, Destinatario, Tienda, Estado, tTurno,Documento From vGuiaTransporte " & _
           "where tUsuario='" & sUsuario & "' and fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' and tCaja='" & sCaja & "' "

'       Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, Estado, Moneda from vEgreso " & _
'       " where tUsuario='" & sUsuario & "' and and fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' order by 1"
    Else
           Isql = "select distinct tGuiaTransporte, fFecha, nTotal, Destinatario, Tienda, Estado, tTurno,Documento From vGuiaTransporte " & _
           "where fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' order by 1 "

       'Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, Estado, Moneda from vEgreso where  fFecha >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00' and fFecha <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59' order by 1"
    End If
   ...
   Screen.MousePointer = vbDefault
End Sub
Private Sub EmiteReporte(ByVal tipo As Integer)
On Error GoTo fin
     Genera
    ...
    If tipo = 1 Then
        ...
        dsrReporte.PaperOrientation = crPortrait
        frmEmite.CRViewer.ViewReport
        frmEmite.Show vbModal
    End If
    If tipo = 2 Then
        dsrReporte.ExportOptions.FormatType = 21
        dsrReporte.ExportOptions.DestinationType = 1
        cmdSave.Filter = "Libro de Microsoft Excel|*.xls"
        cmdSave.ShowSave
        If cmdSave.FileName = "" Then
           Exit Sub
        End If
        dsrReporte.ExportOptions.DiskFileName = cmdSave.FileName
        dsrReporte.Export False
    End If
Exit Sub
fin:
...
On Error GoTo fin
    ...
    Set rsReporte = Lib.OpenRecordset("select tguiatransporte,destinatario,ffecha,ntotal,Estado,documento from vguiatransporte where ffecha between '" & Format(dtpFecIni.value, "yyyyMMdd") & " " & Format("00:00", "HH:mm") & "' and '" & Format(dtpFecFin.value, "yyyyMMdd") & " " & Format("23:59", "HH:mm") & "'" & " group by tguiatransporte,destinatario,ffecha,ntotal,Estado,documento ", Cn)  'oComando.GetSP()
    'RsReporte.Filter = sCriterio
    dsrReporte.DiscardSavedData
    dsrReporte.Database.SetDataSource rsReporte
    dsrReporte.Text10.SetText "Del : " & Format(dtpFecIni.value, "dd/MM/yyyy") & " Al : " & Format(dtpFecFin.value, "dd/MM/yyyy")
    dsrReporte.Text11.SetText sRazonSocial
