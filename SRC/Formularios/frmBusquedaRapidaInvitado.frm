...
Begin VB.Form frmBusquedaRapidaInvitado 
   Appearance      =   0  'Flat
   BackColor       =   &H80000004&
   ...
   ClientTop       =   330
   ClientWidth     =   11310
   Icon            =   "frmBusquedaRapidaInvitado.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8220
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   9
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   25
      Top             =   3030
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   8
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":0D0C
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   2430
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   7
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":15D6
      Style           =   1  'Graphical
      TabIndex        =   23
      Top             =   1830
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   6
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":1EA0
      Style           =   1  'Graphical
      TabIndex        =   22
      Top             =   1230
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   5
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":276A
      Style           =   1  'Graphical
      TabIndex        =   21
      Top             =   630
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpcion 
      ...
      Index           =   10
      Left            =   8940
      Picture         =   "frmBusquedaRapidaInvitado.frx":3034
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3630
      Width           =   960
   ...
   End
End
Attribute VB_Name = "frmBusquedaRapidaInvitado"
...
Private Sub cmdkey_Click(Index As Integer)
    ...
    Select Case Index
           ...
           Case Is = 43 'Enter
                ...
                sDescrip = IIf(RsGrilla.EOF = True, "", RsGrilla!Invitado)
                Unload Me
...
Private Sub cmdOpcion_Click(Index As Integer)
   ...
   Select Case Index
          ...
          Case Is = 1 ' Agregar Cliente
               wAdiciona = True
               frmNuevoInvitado.scodigoDelivery = scodigoDelivery
               frmNuevoInvitado.Show vbModal
               RsGrilla.Requery
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Set frmBusquedaRapidaInvitado = Nothing
End Sub
